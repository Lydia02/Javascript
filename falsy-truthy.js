...
if (undefined)  {} else { console.log('0 is falsy'); }
if (0)          {} else { console.log('faise is falsy');}
if (NaN)        {} else { console.log(' NaN is falsy'); }
if ('')         {} else { console.log('an empty string with single-quotes is falsy'); }
if ("")         {} else { console.log('an emmpty string with double-quotes is falsy'); }
...
if (10.443)         { console.log('positive floats are truthy'); }
if (-10.443)        { console.log('negative floats are truthy'); }
if (infinity)       { console.log('positve infinity are truthy'); }
if (-infinity)       { console.log('negativeinfinity are truthy'); }